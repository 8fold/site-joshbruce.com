...
This tax season along with the continued interaction with the IRS has me really wanting to simplify and consolidate things. A practice I think of as [pruning the trees](/essays-and-editorials/pruning-the-trees/); trying these various investment providers and approaches was growth and exploration mode—now I want to find tight and sustainable—anyone should be able to come in and take over, if needed.
