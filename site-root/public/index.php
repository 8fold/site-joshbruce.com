...
/**
 * Manual tests to consider automating:
 *
 * - Home page
 * - All content page
 * - Experiences - article list
 * - Experiences/Finances - paycheck log list
 * - Experiences/Finances/paycheck (with something before and after) - next/previous
