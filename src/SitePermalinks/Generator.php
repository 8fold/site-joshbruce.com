...
{
    protected static $defaultName = 'compile:permalinks';

    protected static $defaultDescription =
        'Compile redirect links for permalinks used in Atom feed.';
    ...
    protected function configure(): void
    {
        $this->setHelp(
            // phpcs:ignore
            'This command uses the content directory to create a list of permalink short names.'
        );
        ...
        $this->addArgument(
            ...
            // phpcs:ignore
            '/fully/qualified/path/for/static/site/destination - default is the project root in a folder called site-permalink-ids'
        );
    ...
    protected function execute(
        ...
        if ($this->compiledDynamicSite($input, $output)) {
            ...
            $output->writeln([
                '',
                '******************************************',
                "Completed permalink compilation in {$seconds}s",
                ''
            ]);
    ...
    private function compiledDynamicSite(
        ...
        $output->writeln([
            '',
            'Starting permalink compilation',
            '******************************************',
            ''
        ]);
