...
Cash is a liquid asset. It seems that the way we deal with people holding cash is to create more of it. By creating more of it, we typically cause inflation. This is similar to when a company [dilutes its stock](https://www.investopedia.com/ask/answers/06/dilutivestock.asp) by issuing more in response to there being a concentration in the hands of one or more investors. In a way, currency is a share in something, usually a community of some sort, which would include nation-states.
